...
<head>
   ...
   <!--Style css-->
   <link rel="stylesheet" href="css/Questionnaire_pacient_homeo.css">
   ...
   <title>Consulta Homeopatía</title>
</head>
      ...
      <div class="container">
         ...
         <div class="dropdown ms-auto">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
               <li><a class="dropdown-item" href="include_questions/logout.php">Cerrar Sesión</a></li>
            </ul>
         </div>
      </div>
   </nav>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea type="text" name="oncologico" class="form-control hidden-input" id="onco" style="height: 65px; resize: none; border-color: #3C3B3F;"></textarea>
                                       </div>
                                    </div>
                                    <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea type="text" name="alergicos" class="form-control hidden-input" id="aler" style="height: 65px; resize: none; border-color: #3C3B3F;"></textarea>
                                       </div>
                                    </div>
                                    <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea type="text" name="hipertensivos" class="form-control hidden-input" id="hiperten" style="height: 65px; resize: none; border-color: #3C3B3F;"></textarea>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea type="text" name="diabeticos" class="form-control hidden-input" id="diabeticos" style="height: 65px; resize: none; border-color: #3C3B3F;"></textarea>
                                       </div>
                                    </div>
                                    <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea type="text" name="cardio" class="form-control hidden-input" id="cardiovas" style="height: 65px; resize: none; border-color: #3C3B3F;"></textarea>
                                       </div>
                                    </div>
                                    <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea type="text" name="otros" class="form-control hidden-input" id="otros" style="height: 65px; resize: none; border-color: #3C3B3F;"></textarea>
                                       </div>
                                    </div>
                                    <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="observaciones" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="observa1"></textarea>
                                       </div>
                                    </div>
                                    <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="tabaquismo" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="tabaquismo"></textarea>
                                       </div>
                                    </div>
                                    <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="tabpas" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="tabpas"></textarea>
                                       </div>
                                    </div>
                                    <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="hepaticos" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="hepaticos"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="quirurgicos" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="quirurgicos"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="hospitalizacion" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="hospitalizacion"></textarea>
                                       </div>
                                       <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="cardiacos" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="cardiacos"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="renal" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="renal"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="hipertensivos" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="hipertensivos"></textarea>
                                       </div>
                                       <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="diabeticos" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="diabe"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="fracturas" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="fractu"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="neurologicos" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="neurologicos"></textarea>
                                       </div>
                                       <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 tex col-md-12 col-lg-12 col-xl-12">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="observa2" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="observa2"></textarea>
                                       </div>
                                       <script>
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="resultado" type="text" class="form-control hidden-input" id="Resultados" style="height: 70px; resize: none; border-color: #3C3B3F;"></textarea>
                                       </div>
                                       <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="fecha" type="date" class="form-control hidden-input" id="fechastart" style="resize: none; height: 90px; border-color: #3C3B3F;"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="sinto_start" type="text" style="resize: none; height: 90px; border-color: #3C3B3F;" class="form-control hidden-input" id="sinto"></textarea>
                                       </div>
                                       <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="descripcion" style="height: 90px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="descripcion"></textarea>
                                       </div>
                                       <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="resp" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="resp"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="cardio" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="cardio"></textarea>
                                       </div>
                                       <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="digestivo" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="digestivo"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="urinario" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="urinario"></textarea>
                                       </div>
                                       <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="hemo" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="hemo"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="endocrino" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="endocrino"></textarea>
                                       </div>
                                       <script>
                              ...
                              <div class="row sistema">
                                 <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="sis_nerv" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="sis_nerv"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="osteo" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="osteo"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="tegumentos" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="tegumentos"></textarea>
                                       </div>
                                       <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="cabeza" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="cabeza"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="cuello" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="cuello"></textarea>
                                       </div>
                                       <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="torax" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="torax"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="mamas" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="mamas"></textarea>
                                       </div>
                                       <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="abdomen" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="abdomen"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="extremidades" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="extremidades"></textarea>
                                       </div>
                                       <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="inspec" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="inspec"></textarea>
                                       </div>
                                       <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="oftal" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="oftal"></textarea>
                                       </div>
                                       <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="Notas" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control hidden-input" id="Notas"></textarea>
                                       </div>
                                       <script>
