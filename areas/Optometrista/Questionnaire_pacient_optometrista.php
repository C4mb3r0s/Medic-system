...
<head>
   ...
   <title>Consulta Optometrista</title>
</head>
      ...
      <div class="row">
         <div class="formulario  col-sm-4 col-md-6 col-lg-12 col-xl-12 bg-white">
            <div class="total">
               ...
               <form action="include_questions/items_valoraciones.php" method="post" class="form" name="register">
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="valoracion" type="text" class="form-control hidden-input" id="valoracion" style="border-color: #3C3B3F; resize: none;"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="diagnostico" type="text" class="form-control hidden-input" id="diag" style="border-color: #3C3B3F; resize: none;"></textarea>
                                       </div>
                                       <script>
                                          const icon2 = document.getElementById('toggle-icon2');
                                          const input2 = document.getElementById('diag');
