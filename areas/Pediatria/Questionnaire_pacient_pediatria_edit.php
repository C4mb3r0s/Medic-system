...
<head>
   ...
   <title>Edición Consulta Pediatría</title>
</head>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                       <div class="input-group mb-3">
                                          ...
                                          <div class="form-floating">
                                             <textarea name="hospitalizacion" style="height: 80px; resize: none; border-color: #3C3B3F;" class="form-control visible-input" id="hospitalizacion"><?php echo $mostrar['Hospitalizacion']; ?></textarea>
                                          </div>
                                          <script>
                                 ...
                                 <div class="row">
                                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                       <div class="input-group mb-3">
                                          ...
                                          <div class="form-floating visible-input" id="menorca">
                                             <input name="menorca" type="date" class="form-control" id="floatingInputGroup1" style="height: 70px;" value="<?php echo $mostrar['Menorca']; ?>">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                       <div class="input-group mb-3">
                                          ...
                                          <div class="form-floating">
                                             <textarea name="obs_menor" type="text" class="form-control visible-input" id="obs_menor" style="border-color: #3C3B3F; height: 70px; resize: none;"><?php echo $mostrar['Observaciones']; ?></textarea>
                                          </div>
                                          <script>
