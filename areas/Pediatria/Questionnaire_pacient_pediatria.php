...
<head>
   ...
   <!--Style css-->
   <link rel="stylesheet" href="css/Questionnaire_pacient_pediatria.css">
   ...
   <title>Consulta Pediatría</title>
</head>
   ...
   <div class="container my-3">
      <div class="row">
         <div class="formulario  col-sm-4 col-md-6 col-lg-12 col-xl-12 bg-white">
            <div class="total">
               <h2>Interrogatorio Pediatría</h2>
               <div class="row">
                  ...
                  <div class="imprimir col-sm-12 col-md-6 col-lg-3 col-xl-3">
                     <form class="return" method="post" action="include_questions/out_questions.php">
                     ...
                     <script>
                        function abrirPDF(id2) {
                           ...
                           window.open("../../include/Reporte.php?id=" + id2, "_blank", "width=" + ventanaAncho + ", height=" + ventanaAlto + ", left=" + ventanaIzquierda + ", top=" + ventanaArriba);
                        }
                     </script>
                  </div>
               </div>
                  ...
                  <div class="accordion-item">
                     ...
                     <div id="collapseOne" class="accordion-collapse collapse hide" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                           <form class="form" method="post" action="include_questions/items_signosvit.php">
                              <!--1er row-->
                              <div class="row">
                                 <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <input type="text" name="presionart" class="form-control hidden-input" id="presionart" style="height: 65px;">
                                       </div>
                                    </div>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <input type="text" name="satuoxig" class="form-control hidden-input" id="satuoxig" style="height: 65px;">
                                       </div>
                                    </div>
                                    <!-- Agrega el código JavaScript para mostrar/ocultar el input al hacer clic en el icono -->
                                    <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <input type="text" name="frecuenciacard" class="form-control hidden-input" id="frecuenciacard" style="height: 65px;">
                                       </div>
                                    </div>
                                    <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <input type="text" name="peso" class="form-control hidden-input" id="peso" style="height: 65px;">
                                       </div>
                                    </div>
                                    <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <input type="text" name="temperatura" class="form-control hidden-input" id="temperatura" style="height: 62px;">
                                       </div>
                                    </div>
                                    <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <input type="text" name="talla" class="form-control hidden-input" id="talla" style="height: 62px;">
                                       </div>
                                    </div>
                                    <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <input type="text" name="frecresp" class="form-control hidden-input" id="frecresp" style="height: 65px;">
                                       </div>
                                    </div>
                                    <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <input type="text" name="indmasa" class="form-control hidden-input" id="indmasa" style="height: 65px;">
               ...
               <div class="accordion <?php if ($close2 === 'disabled') {
                  ...
                  <div class="accordion-item">
                     ...
                     <div id="collapseTwo" class="accordion-collapse collapse hide" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                           <form action="include_questions/items_antecedentesfam.php" class="form" method="post">
                              <div class="row">
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea type="text" name="oncologico" class="form-control hidden-input" id="onco" style="border-color: #3C3B3F; height: 65px; resize: none;"></textarea>
                                       </div>
                                    </div>
                                    <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea type="text" name="alergicos" class="form-control hidden-input" id="aler" style="border-color: #3C3B3F; height: 65px; resize: none;"></textarea>
                                       </div>
                                    </div>
                                    <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea type="text" name="hipertensivos" class="form-control hidden-input" id="hiperten" style="border-color: #3C3B3F; height: 65px; resize: none;"></textarea>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea type="text" name="diabeticos" class="form-control hidden-input" id="diabeticos" style="border-color: #3C3B3F; height: 65px; resize: none;"></textarea>
                                       </div>
                                    </div>
                                    <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea type="text" name="cardio" class="form-control hidden-input" id="cardiovas" style="border-color: #3C3B3F; height: 65px; resize: none;"></textarea>
                                       </div>
                                    </div>
                                    <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea type="text" name="otros" class="form-control hidden-input" id="otros" style="border-color: #3C3B3F; height: 65px; resize: none;"></textarea>
                                       </div>
                                    </div>
                                    <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="observaciones" style="border-color: #3C3B3F; height: 80px; resize: none;" class="form-control hidden-input" id="observa1"></textarea>
                                       </div>
                                    </div>
                                    <script>
               ...
               <div class="accordion <?php if ($close3 === 'disabled') {
                  ...
                  <div class="accordion-item">
                     ...
                     <div id="collapsethree" class="accordion-collapse collapse hide" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                           <form action="include_questions/items_ante_patologicos.php" class="form tres" method="post">
                              <!--Primera Fila-->
                              <div class="row">
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="tabaquismo" style="border-color: #3C3B3F; height: 80px; resize: none;" class="form-control hidden-input" id="tabaquismo"></textarea>
                                       </div>
                                    </div>
                                    <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="tabpas" style="border-color: #3C3B3F; height: 80px; resize: none;" class="form-control hidden-input" id="tabpas"></textarea>
                                       </div>
                                    </div>
                                    <script>
                              ...
                              <div class="row hidden-div" id="div">
                                 <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <input name="inicio" type="text" class="form-control" id="floatingInputGroup1">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <input name="cantidad" type="text" class="form-control" id="floatingInputGroup1">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="input-group mb-3">
                                       <span class="input-group-text">
                                          <label for="" style="font-size: 15px; color: white; width: 90px;"> Ex-Tabaquismo</label>
                                       </span>
                                       <div class="form-floating">
                                          <input name="ext_tab" type="text" class="form-control" id="floatingInputGroup1">
                                       </div>
                                    </div>
                                 </div>
                                 <script>
                                    const icon19 = document.getElementById('toggle-icon16');
                                    const icon20 = document.getElementById('toggle-icon17');
                                    const input18 = document.getElementById('div');

                                    let isInputVisible18 = false;

                                    icon19.addEventListener('click', () => {
                                       if (isInputVisible18) {
                                          input18.classList.remove('visible-div');
                                          input18.classList.add('hidden-div');

                                          // Habilita el icon17
                                          icon20.classList.remove('disabled');
                                       } else {
                                          input18.classList.remove('hidden-div');
                                          input18.classList.add('visible-div');
                                          input18.focus(); // Puedes hacer que el input obtenga el enfoque automáticamente.

                                          // Deshabilita el icon17
                                          icon20.classList.add('disabled');
                                       }

                                       // Cambia el estado de isInputVisible18
                                       isInputVisible18 = !isInputVisible18;
                                    });
                                    ...
                                    icon20.addEventListener('click', () => {
                                       if (isInputVisible18) {
                                          ...
                                          // Habilita el icon16
                                          icon19.classList.remove('disabled');
                                       } else {
                                          input18.classList.remove('hidden-div');
                                          input18.classList.add('visible-div');
                                          input18.focus(); // Puedes hacer que el input obtenga el enfoque automáticamente.

                                          // Deshabilita el icon16
                                          icon19.classList.add('disabled');
                                       }
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="hepaticos" style="border-color: #3C3B3F; height: 80px; resize: none;" class="form-control hidden-input" id="hepaticos"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="quirurgicos" style="border-color: #3C3B3F; height: 80px; resize: none;" class="form-control hidden-input" id="quirurgicos"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="hospitalizacion" style="border-color: #3C3B3F; height: 80px; resize: none;" class="form-control hidden-input" id="hospitalizacion"></textarea>
                                       </div>
                                       <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="cardiacos" style="border-color: #3C3B3F; height: 80px; resize: none;" class="form-control hidden-input" id="cardiacos"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="renal" style="border-color: #3C3B3F; height: 80px; resize: none;" class="form-control hidden-input" id="renal"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="hipertensivos" style="border-color: #3C3B3F; height: 80px; resize: none;" class="form-control hidden-input" id="hipertensivos"></textarea>
                                       </div>
                                       <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="diabeticos" style="border-color: #3C3B3F; height: 80px; resize: none;" class="form-control hidden-input" id="diabe"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="fracturas" style="border-color: #3C3B3F; height: 80px; resize: none;" class="form-control hidden-input" id="fractu"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="neurologicos" style="border-color: #3C3B3F; height: 80px; resize: none;" class="form-control hidden-input" id="neurologicos"></textarea>
                                       </div>
                                       <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 tex col-md-12 col-lg-12 col-xl-12">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="observa" style="border-color: #3C3B3F; height: 80px; resize: none;" class="form-control hidden-input" id="observa2"></textarea>
                                       </div>
                                       <script>
               ...
               <div class="accordion <?php if ($close4 === 'disabled') {
                  ...
                  <div class="accordion-item">
                     ...
                     <div id="collapseFour" class="accordion-collapse collapse hide" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                           <form action="include_questions/items_ginecologicos.php" class="form" method="post">
                              <div class="row">
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating hidden-input" id="divi">
                                          <input name="fecha" type="date" class="form-control" id="floatingInputGroup1" style="height: 70px;">
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="resultado" type="text" class="form-control hidden-input" id="Resultados" style="border-color: #3C3B3F; height: 70px; resize: none;"></textarea>
                                       </div>
                                       <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       <span class="input-group-text" id="toggle-icon54" style="width: 120px;">
                                          <label style="font-size: 15px; color: white; width: 90px;">Menorca</label>
                                       </span>
                                       <div class="form-floating hidden-input" id="menorca">
                                          <input name="menorca" type="date" class="form-control" id="floatingInputGroup1" style="height: 70px;">
                                          <label for="floatingInputGroup1">Fecha de la Menorca</label>
                                       </div>
                                       <script>
                                          const icon54 = document.getElementById('toggle-icon54');
                                          const input54 = document.getElementById('menorca');

                                          let isInputVisible54 = false;
                                          icon54.addEventListener('click', () => {
                                             if (isInputVisible54) {
                                                input54.classList.remove('visible-input');
                                                input54.classList.add('hidden-input');
                                             } else {
                                                input54.classList.remove('hidden-input');
                                                input54.classList.add('visible-input');
                                                input54.focus(); // Puedes hacer que el input obtenga el enfoque automáticamente.
                                             }
                                             isInputVisible54 = !isInputVisible54;
                                          });
                                       </script>
                                    </div>
                                 </div>
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       <span class="input-group-text" id="toggle-icon55" style="width: 120px; height: 70px;">
                                          <label for="" style="font-size: 15px; color: white; width: 90px;">Observaciones</label>
                                       </span>
                                       <div class="form-floating">
                                          <textarea name="obs_menor" type="text" class="form-control hidden-input" id="obs_menor" style="border-color: #3C3B3F; height: 70px; resize: none;"></textarea>
                                       </div>
                                       <script>
                                          const icon55 = document.getElementById('toggle-icon55');
                                          const input55 = document.getElementById('obs_menor');

                                          let isInputVisible55 = false;
                                          icon55.addEventListener('click', () => {
                                             if (isInputVisible55) {
                                                input55.classList.remove('visible-input');
                                                input55.classList.add('hidden-input');
                                             } else {
                                                input55.classList.remove('hidden-input');
                                                input55.classList.add('visible-input');
                                                input55.focus(); // Puedes hacer que el input obtenga el enfoque automáticamente.
                                             }
                                             isInputVisible55 = !isInputVisible55;
                                          });
                                       </script>
                                    </div>
                                 </div>
               ...
               <div class="accordion <?php if ($close5 === 'disabled') {
                  ...
                  <div class="accordion-item">
                     ...
                     <div id="collapseFive" class="accordion-collapse collapse hide" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                           <form action="include_questions/items_padecimiento_actual.php" class="form" method="post">
                              <!--Primera fila-->
                              <div class="row">
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="fechastart" type="date" class="form-control hidden-input" id="fechastart" style="border-color: #3C3B3F; resize: none; height: 90px;"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="sinto_start" type="text" style="border-color: #3C3B3F; resize: none; height: 90px;" class="form-control hidden-input" id="sinto"></textarea>
                                       </div>
                                       <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="descripcion" style="border-color: #3C3B3F; height: 90px; resize: none;" class="form-control hidden-input" id="descripcion"></textarea>
                                       </div>
                                       <script>
               ...
               <div class="accordion <?php if ($close6 === 'disabled') {
                  ...
                  <div class="accordion-item">
                     ...
                     <div id="collapseSix" class="accordion-collapse collapse hide" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                           <form action="include_questions/items_interrogatorio_apa.php" class="form" method="post">
                              <!--Primera fila-->
                              <div class="row">
                                 <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="resp" style="border-color: #3C3B3F; height: 80px; resize: none;" class="form-control hidden-input" id="resp"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="cardio" style="border-color: #3C3B3F; height: 80px; resize: none;" class="form-control hidden-input" id="cardio"></textarea>
                                       </div>
                                       <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="digestivo" style="border-color: #3C3B3F; height: 80px; resize: none;" class="form-control hidden-input" id="digestivo"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="urinario" style="border-color: #3C3B3F; height: 80px; resize: none;" class="form-control hidden-input" id="urinario"></textarea>
                                       </div>
                                       <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="hemo" style="border-color: #3C3B3F; height: 80px; resize: none;" class="form-control hidden-input" id="hemo"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="endocrino" style="border-color: #3C3B3F; height: 80px; resize: none;" class="form-control hidden-input" id="endocrino"></textarea>
                                       </div>
                                       <script>
                              ...
                              <div class="row sistema">
                                 <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="sis_nerv" style="border-color: #3C3B3F; height: 80px; resize: none;" class="form-control hidden-input" id="sis_nerv"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="osteo" style="border-color: #3C3B3F; height: 80px; resize: none;" class="form-control hidden-input" id="osteo"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="tegumentos" style="border-color: #3C3B3F; height: 80px; resize: none;" class="form-control hidden-input" id="tegumentos"></textarea>
                                       </div>
                                       <script>
               ...
               <div class="accordion <?php if ($close7 === 'disabled') {
                  ...
                  <div class="accordion-item">
                     ...
                     <div id="collapseSeven" class="accordion-collapse collapse hide" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                           <form action="include_questions/items_exploracion.php" class="form" method="post">
                              <!--Tercer row-->
                              <div class="row">
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="cabeza" style="border-color: #3C3B3F; height: 80px; resize: none;" class="form-control hidden-input" id="cabeza"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="cuello" style="border-color: #3C3B3F; height: 80px; resize: none;" class="form-control hidden-input" id="cuello"></textarea>
                                       </div>
                                       <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="torax" style="border-color: #3C3B3F; height: 80px; resize: none;" class="form-control hidden-input" id="torax"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="mamas" style="border-color: #3C3B3F; height: 80px; resize: none;" class="form-control hidden-input" id="mamas"></textarea>
                                       </div>
                                       <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="abdomen" style="border-color: #3C3B3F; height: 80px; resize: none;" class="form-control hidden-input" id="abdomen"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="extremidades" style="border-color: #3C3B3F; height: 80px; resize: none;" class="form-control hidden-input" id="extremidades"></textarea>
                                       </div>
                                       <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="inspec" style="border-color: #3C3B3F; height: 80px; resize: none;" class="form-control hidden-input" id="inspec"></textarea>
                                       </div>
                                       <script>
               ...
               <div class="accordion <?php if ($close8 === 'disabled') {
                  ...
                  <div class="accordion-item">
                     ...
                     <div id="collapseEight" class="accordion-collapse collapse hide" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                           <form action="include_questions/items_evaluaciones.php" id="myForm" class="form" method="post">
                              <div class="row">
                                 <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="oftal" style="border-color: #3C3B3F; height: 80px; resize: none;" class="form-control hidden-input" id="oftal"></textarea>
                                       </div>
                                       <script>
               ...
               <div class="accordion <?php if ($close9 === 'disabled') {
                  ...
                  <div class="accordion-item">
                     ...
                     <div id="collapseNine" class="accordion-collapse collapse hide" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                           <form action="include_questions/items_notas_med.php" id="myForm" class="form" method="post">
                              <div class="row">
                                 <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="input-group mb-3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="Notas" style="border-color: #3C3B3F; height: 80px; resize: none;" class="form-control hidden-input" id="Notas"></textarea>
                                       </div>
                                       <script>
               ...
               <div class="container final fin">
                  <form action="../../include/termino_consulta.php" method="post" class="form">
