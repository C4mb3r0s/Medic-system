...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $consulta = "UPDATE signosvitales SET PresionArt ='$presionart', SaturacionOx='$satuoxig', FrecuenciaCar='$frecuenciacard',
     PesoActual='$peso', Temperatura='$temperatura', Talla='$talla', FrecuenciaRes='$frecresp', IndiceMasaCorp='$indmasa' 
