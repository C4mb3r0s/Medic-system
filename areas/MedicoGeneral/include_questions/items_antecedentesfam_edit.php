...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $consulta = "UPDATE heredofam SET Oncologico ='$oncologico', Alergicos='$alergicos', Hipertensivos='$hipertensivos',
    Diabeticos ='$diabeticos', Cardiovasculares='$cardio', Otros='$otros', Observaciones='$observaciones' 
