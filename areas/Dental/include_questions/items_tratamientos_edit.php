...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($mysqli->query($consulta) === TRUE) {
        ...
        $consulta2 = "UPDATE tratamientosdental 
                    SET Consulta = '$consulta3',
                        Curacion = '$curacion',
        ...
        if ($mysqli->query($consulta2) === TRUE) {
            ...
            echo '<script language="javascript"> alert("Tratamientos editados correctamente"); window.history.back(); </script>';
            exit();
        } else {
