      ...
      <div class="row">
         <div class="formulario  col-sm-4 col-md-6 col-lg-12 col-xl-12 bg-white">
            <div class="total">
               ...
               <form action="include_questions/items_tratamientos.php" method="post" class="form" name="register">
                              ...
                              <div class="row" style="margin-bottom: 10px;">
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="consulta" type="text" class="form-control hidden-input" id="consulta" style="border-color: #3C3B3F; resize: none; height: 90px;"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="curacion" type="text" class="form-control hidden-input" id="curacion" style="border-color: #3C3B3F; height: 90px; resize: none;"></textarea>
                                       </div>
                                       <script>
                              ...
                              <div class="row" style="margin-bottom: 10px;">
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="extraccion" type="text" class="form-control hidden-input" id="extraccion" style="border-color: #3C3B3F; height: 90px; resize: none;"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="pulpotomia" type="text" class="form-control hidden-input" id="pulpotomia" style="border-color: #3C3B3F; resize: none; height: 90px;"></textarea>
                                       </div>
                                       <script>
                              ...
                              <div class="row" style="margin-bottom: 10px;">
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="limpieza" type="text" class="form-control hidden-input" id="limpieza" style="border-color: #3C3B3F; height: 90px; resize: none;"></textarea>
                                       </div>
                                       <script>
                                 ...
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="radiografia" type="text" class="form-control hidden-input" id="radiografia" style="border-color: #3C3B3F; height: 90px; resize: none;"></textarea>
                                       </div>
                                       <script>
                              ...
                              <div class="row" style="margin-bottom: 10px;">
                                 <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="resina" type="text" class="form-control hidden-input" id="resina" style="border-color: #3C3B3F; height: 90px; resize: none;"></textarea>
                                       </div>
                                       <script>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="input-group mb3">
                                       ...
                                       <div class="form-floating">
                                          <textarea name="Nota" type="text" class="form-control hidden-input" id="Nota" style="border-color: #3C3B3F; height: 90px; resize: none;"></textarea>
                                       </div>
                                       <script>
