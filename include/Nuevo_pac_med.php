...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($resultado_existencia->num_rows > 0) {
        ...
        echo '<script language="javascript"> alert("El paciente ya existe"); window.location.href="../Nuevo_pacient_med.php";  </script>';
    } else {
        ...
        if ($mysqli->query($consulta) === TRUE) {
            ...
            if ($mysqli->query($otraConsulta) === TRUE) {
                ...
                echo '<script language="javascript"> alert("Paciente agregado correctamente"); window.location.href="../dashboard_medico.php" </script>';
